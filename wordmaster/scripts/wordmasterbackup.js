...
function showWaterBalloon() {
  ...
  play_again.style.zIndex = '9999'
  canvas.classList.remove('water_balloon')
  canvas.style.position = 'fixed'
  canvas.style.top = '50%'
  canvas.style.left = '50%'
  canvas.style.transform = 'translate(-50%, -50%)'
  canvas.style.zIndex = '1' // Much lower z-index
  canvas.style.pointerEvents = 'none' // Make sure clicks go through
  animate(0)

  // Hide the balloon after animation
  setTimeout(() => {
    canvas.classList.add('water_balloon')
